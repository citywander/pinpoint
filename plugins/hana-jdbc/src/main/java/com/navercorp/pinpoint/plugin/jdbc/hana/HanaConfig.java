 ...
 * @author Jongho Moon
 */
public class HanaConfig extends JdbcConfig {
    ...
    public String toString() {
        return "HanaConfig [" + super.toString() + ", profileSetAutoCommit=" + profileSetAutoCommit + ", profileCommit=" + profileCommit + ", profileRollback=" + profileRollback + "]";
    }
}
